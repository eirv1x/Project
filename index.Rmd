...
Within this dataset, personal-well being was based on four measures: 'Anxiety', 'Life Satisfaction', 'Worthwhile', and 'Happiness'. These variables represented the average mean score from the dataset for each measure. For this data visualisation, I focused only on personal well-being scores from UK countries.
...
The shiny app created displays a personal well-being scores of each country on a scatterplot. The interactive feature of this graph enables a user to choose which year they would like to view the data from. The app further allows a user to download the plots.
...
Shiny interactive graph [link](http://127.0.0.1:5691/index.Rmd)
...
When completing this project the main resoruces I found helpful were [stackoverflow.com](https://stackoverflow.com/) and [rStudio.com](https://www.rstudio.com/). In particular the cheatsheets provided on rStudio were extremely helpful for more simple code.
