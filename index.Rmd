...
Life Satisfaction|'How satisifed are you with your life nowadays?'
...
As a jitter was not used, not all the points could be seen as some overlapped. Therefore, I added in a jitter to my test visualisation. I played around with the exact height and width of the jitter until I found one that displayed each point perfectly, without being jittered too much. 
...
The shiny app created displays personal well-being scores of each country on a scatterplot. The interactive feature of this graph enables a user to choose which year they would like to view the data from. The app further allows a user to download the plots to their own device.
...
Based on the Shiny graphs, it is evident that overall, Northern Ireland has consistently higher PWB scores across all measures over the years, in comparison to other UK countries. 

Individual Measures:

Anxiety - It appears that Wales consistently has higher ratings overall. Except for the year 2019-20 where Scotland had the highest Anxiety score. This is interesting given that in 2019-20 the COVID pandemic started, therefore this could be an interesting future direction to look at. Did COVID-19 have an impact on countries Anxiety levels?
...
Worthwhile - Scotland mainly had the lowest worthwhile scores. However, in 2017-18 the low score was consistent across UK countries, with the exception of Northern Ireland. Furthermore, in 2019-20, Scotland actually appeared to have the second highest Worthwhile score, with Wales and England coming in lower. This again could relate to the impact of COVID-19 and further research exploring this could be interesting. 

These findings are important as they can help inform the policy-making process with which countries need more help with their personal well-being than others.Based on the interpretation of the visualisation created, Northern Ireland seems to need less help with their personal well-being. Whilst Scotland and Wales could benefit more from interventions to improve their overall personal well-being. 
...
- the importance of annotating code so that others can understand what I have done, and why? As well as enabling others to then accruately reproduce the graphs that I have created.
- that it is necessary to be very specific in what you are asking R to do. For example, when setting up my scatterplot originally using 'y=year', R would not retrieve the right data and so using 'y=get(year)' was necessary to ensure that R understood the specific data I wanted to use for my scatterplot. 
...
- I would also have created more visualisations, to show personal well-being scores from specific georgraphical locations. For example, counties within the UK, as well as countries. 
